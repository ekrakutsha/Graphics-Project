...
void initGL()
{
   ...
   glClearColor(0.5f, 0.7f, 1.0f, 1.0f); // Sky blue color (R=0.5, G=0.7, B=1.0)
}
...
case 'd':
    glClearColor(0.223529f, 0.635294f, 0.956863f, 1.0f);
	glutPostRedisplay();
break;
...
glPopMatrix();
    ...
    glColor3ub(0, 51, 102); // Medium blue color
    glBegin(GL_POLYGON);
    glVertex2f(-1.0f, -0.4f); // Left bank
    glVertex2f(-1.0f, -1.0f); // Left bank
    glVertex2f(1.0f, -1.0f); // Right bank
    glVertex2f(1.0f, -0.4f); // Right bank
    glEnd();

    glBegin(GL_QUADS);///river
	glColor3ub(64, 64, 64); // Dark gray // Sea water color (R=0.0, G=0.4, B=0.6, Alpha=1.0
...
{
    std::cout<<"............AHAMMED EKRAK HOSSAIN UTSHA  -- 21-45058-2............."<<std::endl;
    std::cout<<"............SHADMAN SAKIB FARUKI         -- 21-45154-2............."<<std::endl;
    std::cout<<"............MD ABDULLAH AL MAMUN         -- 21-45296-2............."<<std::endl;
    std::cout<<"............ISTIAK MAHMUD ANIK           -- 22-47134-1............."<<std::endl;
    std::cout<<"............MEHEDI HASAN                 -- 22-46907-1............."<<std::endl;
	glutInit(&argc, argv);
